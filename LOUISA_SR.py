...
if __name__ == "__main__":
    ...
    while True:
        ...
        for current_task in task_list:
            ...
            current_task_next_deadline = (
                current_task.EXECUTION_TIME + current_task.PERIOD
            )
            ...
            print(
                ...
                + current_task.NAME
                + " : "
                + str(current_task_next_deadline)
            )
                ...
                if current_task.NAME == "Pump1":
                    ...
                    if (
                        operator.ge(
                            ...
                            + datetime.timedelta(0, task_to_run.PERIOD)
                        )
                        and task_to_run.PRIORITY != 4
                    ):
                        ...
                        if oil > 50:
                            oil = oil - (oil - 50)
                        print(
                            task_to_run.LAST_EXECUTED_TIME.strftime("%H:%M:%S")
                            + " :"
                            + task_to_run.NAME
                            + ": add 10 oil in tank. Tank have now "
                            + str(oil)
                            + " oil"
                        )
        ...
        for current_task in task_list:
            ...
            if (
                current_task.PRIORITY < task_to_run.PRIORITY
                and current_task.COOLDOWN <= 0
            ):
                task_to_run = current_task
